...
public class ClientAPI_TunBuilderBase {
    ...
    protected static long swigRelease(ClientAPI_TunBuilderBase clientAPI_TunBuilderBase) {
        if (clientAPI_TunBuilderBase == null) {
            return 0L;
        }
    ...
    public boolean tun_builder_set_dns_options(DnsOptions dnsOptions) {
        return ovpncliJNI.ClientAPI_TunBuilderBase_tun_builder_set_dns_options(this.swigCPtr, this, DnsOptions.getCPtr(dnsOptions), dnsOptions);
    }
